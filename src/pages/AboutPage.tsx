...
export default function AboutPage() {
  ...
  return <>
    <SEO title="Sobre a Schultz Energia Solar | Linhares-ES" description={description} path="/sobre/" schema={[webPageSchema("Sobre a Schultz Energia Solar | Linhares-ES", "/sobre/"), breadcrumbSchema([{ name: "Início", path: "/" }, { name: "Sobre", path: "/sobre/" }])]} />
    ...
    <section className="section-padding bg-background"><div className="container-max mx-auto grid lg:grid-cols-2 gap-12"><div><p className="text-primary uppercase font-bold text-sm mb-3">Nossa atuação</p><h2 className="font-display text-3xl md:text-4xl font-bold text-secondary mb-5">Mais de 170 projetos realizados</h2><div className="space-y-5 text-lg text-muted-foreground leading-relaxed"><p>A Schultz Energia Solar nasceu em Linhares com foco exclusivo em energia solar fotovoltaica. Em mais de 3 anos de experiência, já executamos mais de 170 projetos residenciais, comerciais e rurais.</p><p>Atuamos em Linhares e na Região Norte do Espírito Santo com equipe própria. Isso permite acompanhar de perto cada etapa: atendimento, dimensionamento, projeto, instalação, homologação, monitoramento e pós-venda.</p><p>Nosso compromisso é simples: explicar com clareza, dimensionar com responsabilidade, executar com qualidade e continuar disponível depois da entrega.</p></div></div><div className="bg-secondary text-secondary-foreground p-8 rounded-lg"><h2 className="font-display text-2xl font-bold mb-6">Schultz em números</h2><dl className="grid grid-cols-2 gap-6"><div><dt className="text-primary text-3xl md:text-4xl font-display font-bold">170+</dt><dd className="text-sm text-secondary-foreground/65 mt-1">projetos realizados</dd></div><div><dt className="text-primary text-3xl md:text-4xl font-display font-bold">3+</dt><dd className="text-sm text-secondary-foreground/65 mt-1">anos de experiência</dd></div><div><dt className="text-primary text-3xl md:text-4xl font-display font-bold">Até 90%</dt><dd className="text-sm text-secondary-foreground/65 mt-1">de economia na conta de luz</dd></div><div><dt className="text-primary text-3xl md:text-4xl font-display font-bold">100%</dt><dd className="text-sm text-secondary-foreground/65 mt-1">equipe própria</dd></div></dl></div></div></section>
