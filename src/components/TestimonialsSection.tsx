      ...
      <div className="container-max mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Mais de 500 clientes satisfeitos em todo o Brasil. Confira alguns 
            depoimentos de quem já economiza com energia solar.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <button
            onClick={prevSlide}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-4 w-12 h-12 rounded-full bg-background shadow-medium flex items-center justify-center text-secondary hover:text-primary transition-colors"
            aria-label="Anterior"
          >
          ...
          <button
            onClick={nextSlide}
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-4 w-12 h-12 rounded-full bg-background shadow-medium flex items-center justify-center text-secondary hover:text-primary transition-colors"
            aria-label="Próximo"
          >
